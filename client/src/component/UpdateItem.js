...
export default function UpdateItem() {
  ...
  const item={
      ...
      priorityNr:e.target.priorityNr.value
  }
...
try{
    ...
    return item? (
        ...
        <Link to='/' className='text-white close fs-2 bg-danger p-2'>X</Link>
            ...
            <form className="row g-3 justify-content-center align-items-center flex-column mt-3" onSubmit={UpdateItems}>
            <div className="col-6">
            ...
            <label htmlFor="exampleInputText" className="form-label text-white">Priority</label>
                <input type="number" className="form-control" name="priorityNr" id="priorityNr" defaultValue={item.priorityNr} />
            </div>
            <div className="col-6">
